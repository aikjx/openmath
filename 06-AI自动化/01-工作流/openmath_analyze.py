...
METHODS = [
    ...
    dict(id="gaussian_elimination", name="高斯消元", domain="线性代数", implemented=False,
         where=None, description="解线性方程组、求秩。",
         limitation="未实现。"),
    ...
    dict(id="asymptotic_estimation", name="渐近估计", domain="解析数论", implemented=False,
         where=None, description="对计数函数做渐近展开。",
         limitation="未实现。"),
    dict(id="circle_method", name="圆法", domain="解析数论", implemented=False,
         where=None, description="Hardy–Littlewood 圆法，处理加性数论问题。",
         limitation="未实现。"),
    dict(id="sieve_theory", name="筛法（解析）", domain="解析数论", implemented=False,
         where=None, description="Selberg/大筛法等，用于孪生素数、哥德巴赫类问题。",
         limitation="未实现。"),
    dict(id="modular_analysis", name="模类分析", domain="数论", implemented=False,
         where=None, description="按剩余类化简分析问题。",
         limitation="未实现。"),
    ...
    dict(id="cohomology_computation", name="上同调计算", domain="代数几何", implemented=False,
         where=None, description="计算代数簇的上同调群。",
         limitation="未实现。"),
    ...
    dict(id="renormalization", name="重整化", domain="数学物理", implemented=False,
         ...
         limitation="未实现。"),
    dict(id="rad_computation", name="rad 计算", domain="数论", implemented=False,
         where=None, description="计算 rad(n)（互素素因子之积）用于 ABC 猜想检验。",
         limitation="未实现。"),
